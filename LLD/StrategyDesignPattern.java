...
abstract class Robot {
    ...
    public void walk() {  // Delegating walk behavior to the strategy
        walkBehavior.walk();
    }
...
class WorkerRobot extends Robot {
    public WorkerRobot(WalkableRobot w, TalkableRobot t, FlyableRobot f) { // Constructor to initialize behaviors
        super(w, t, f);
    }
